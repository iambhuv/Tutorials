const _userInput = document.getElementById("user__Input"), $userSubmit = $("#user__Input__Submit"), $_resutBox = document.getElementById("resutBox"), toggleMuchLineIndex = $("#toggleMuchLineIndex"), user__MuchLineInput = document.getElementById("user__MuchLineInput");
let parsedVal;
let FinalValue = "";
...
const checkFunction2 = () => {
    ...
    if (isNaN(parsedVal) || parsedVal == 0) {
        ...
        TableLineValue = user__MuchLineInput.value = Math.floor(user__MuchLineInput.value);
    }
}
const printTable = () => {
    if (!FinalValue == "") {
        // if (user__MuchLineInput.value >= 200) {
        //     alert("Warning : This Can Make Your Device Unresponsive")
        // }
        (user__MuchLineInput.value >= 200? alert("Warning : This Can Make Your Device Unresponsive"):null)
